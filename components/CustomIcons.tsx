...
import Svg, { Path, G, View as SvgView } from "react-native-svg";
...
// Wrapper to ensure consistent icon sizing
...
export const PlaneAltIcon = ({ color = "#000", size = 24 }: IconProps) => (
    <IconWrapper size={size}>
        <Svg width={size * (960/1024)} height={size} viewBox="0 0 960 1024">
            <Path
                fill={color}
